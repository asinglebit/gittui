...
impl App {
    ...
    pub fn load_keymap(&mut self) {
        ...
        map.insert(KeyBinding::new(Enter, KeyModifiers::NONE), Command::Act);
        map.insert(KeyBinding::new(Tab, KeyModifiers::NONE), Command::Tab);
        ...
        map.insert(KeyBinding::new(Esc, KeyModifiers::NONE), Command::Close);
    ...
    pub fn handle_key_event(&mut self, key_event: KeyEvent) {
        ...
        if let Some(cmd) = self.keymap.get(&key_binding) {
            match cmd {
                ...
                Command::Act => self.on_act(),
                Command::Tab => self.on_tab(),
                Command::GoToBeginning => self.on_go_to_beginning(),
                Command::GoToEnd => self.on_go_to_end(),
                Command::PageUp => self.on_page_up(),
                Command::PageDown => self.on_page_down(),
    ...
    pub fn on_go_to_beginning(&mut self) {
        match self.focus {
            Focus::Branches => {
